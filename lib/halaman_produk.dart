...
class _HalamanProdukState extends State<HalamanProduk> {
  ...
  Future _getdata() async {
    try {
      final respon = await http.get(Uri.parse('http://10.211.41.251/api_produk/read.php'));
  ...
  Future _hapus(String id) async {
    try {
      final respon = await http.post(Uri.parse('http://10.211.41.251/api_produk/read.php/api_produk/delete.php'), body: {"id_produk": id});
      if (respon.statusCode == 200) {
        final data = jsonDecode(respon.body);
        setState(() {
          _listdata = data;
